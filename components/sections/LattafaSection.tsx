...
export default function LattafaSection() {
  const products = useQuery(api.products.list, { brand: "Lattafa", status: "Active" });
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            <p className="text-[#C9A96E] text-xs tracking-[0.3em] uppercase font-semibold mb-2">Premium Collection</p>
            <h2 className="text-white text-3xl sm:text-4xl font-bold tracking-tight">Lattafa</h2>
          </div>
          <Link
            href="/products"
        ...
        {products === undefined ? (
          ...
          <div className="py-20 text-center border border-dashed border-white/10 rounded-2xl">
            <p className="text-white/20 text-lg">No Lattafa products yet.</p>
            <p className="text-white/10 text-sm mt-1">Add products with brand &quot;Lattafa&quot; in the admin to show them here.</p>
          </div>
        ) : (
          <motion.div
            variants={container}
